========================================================================
    ACTIVEX 控件 DLL : demo 项目概述
========================================================================

控件向导已为 demo ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 demo ActiveX 控件 DLL 的每个文件的内容。
...
demoCtrl.h
    此文件包含 CdemoCtrl C++ 类的声明。

demoCtrl.cpp
    此文件包含 CdemoCtrl C++ 类的实现。

demoPropPage.h
    此文件包含 CdemoPropPage C++ 类的声明。

demoPropPage.cpp
    此文件包含 CdemoPropPage C++ 类的实现。

CdemoCtrl.bmp
    此文件包含一个位图，当 CdemoCtrl 控件出现在工具面板上时，容器将使用此位图来表示该控件。此位图包含在主资源文件 demo.rc 中。

/////////////////////////////////////////////////////////////////////////////
其他标准文件:

stdafx.h, stdafx.cpp
    这些文件用于生成名为 demo.pch 的预编译头 (PCH) 文件和名为 stdafx.obj 的预编译类型 (PCT) 文件。
